            ...
            <div className="flex flex-1 flex-col justify-between">
                <div className="">
                    <div className="grid grid-cols-3 p-4 pt-0 gap-4">
                        <Input onChange={onChange} value={values.senderAccountName} error={errors.senderAccountName} name="senderAccountName" label="Sender Account Name" style="rounded-lg" />
                        <Input onChange={onChange} value={values.senderAccountNumber} error={errors.senderAccountNumber} name="senderAccountNumber" label="Sender Account Number" style="rounded-lg" />
                        <Input onChange={onChange} value={values.senderBankName} error={errors.senderBankName} name="senderBankName" label="Sender Bank Name" style="rounded-lg" />
                    ...
                    <div className="grid grid-cols-4 p-4 pt-0 gap-4">
                        ...
                        <Input onChange={onChange} value={values.date} error={errors.date} name="date" label="Date" style="rounded-lg" />
                        <Select onChange={onChange} value={values.status} error={errors.status} name="status" label="Status" data={["", "pending", "successful", "failed"]} style="rounded-lg" />
                    </div>
                </div>
